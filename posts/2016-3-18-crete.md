...
<div class="row">
    <div class="ratio ratio-16x9">
        <iframe src="https://www.youtube.com/embed/hJkIgraE530" frameborder="0" allowfullscreen></iframe>
    </div>
</div>

<div class="row">
    <div class="col-md-12">
        <p > Who knew organic material could be so useful? The first connected brick for the age of electronic homes and useless devices. It does everything you might want from a Fitbit and yet it is in a form factor that is unwieldy and impractical. It uses haptics to communicate to users when they are not mindful. Created in collaboration with <a href="https://oryano.com">Oryan Inbar</a>
        </p>
    </div>
</div>
<div class="row">	
<div class="col-md-6">
    <img src="../images/crete-process.jpg" class="img-fluid mx-auto d-block" alt="Crete Process Img 1"/>
    <p class="caption">
...
<div class="col-md-6">
    <img src="../images/crete-process-2.jpg" class="img-fluid mx-auto d-block" alt="Crete Process Img 2" />
    <p class="caption">
...
<div class="row">
<div class="col-md-6">
    <img src="../images/crete-process-4.jpg" class="img-fluid mx-auto d-block" alt="Crete Process Img 4"/>
    <p class="caption">
...
<div class="col-md-6">
    <img src="../images/crete-process-3.jpg" class="img-fluid mx-auto d-block" alt="Crete Process Img 3"/>
    <p class="caption">
...
<div>
    <div class="ratio ratio-16x9"><iframe src="https://www.youtube.com/embed/GyFxrQd7-zw?list=PLp1AzLEITCFxnF3zXRn5ZErynB5Vg5Ynr" frameborder="0" allowfullscreen></iframe></div>
</div>
